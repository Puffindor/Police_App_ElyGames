  ...
  <div class="prof">
    ...
    <div class="profile">
      ...
      <div class="list">
        ...
        <span>
          <span class="bold">Birthday: </span>{{ this.list.birthday }}</span
        >
      ...
      <div class="icon_container">
        ...
        <img src="/src/Assets/icons/logo.png" style="margin-top: 35px" />
      </div>
    </div>
    ...
    <div class="a">
      <div class="prints_container prints_container1">
        ...
        <div class="print_item finger1">
          <img src="/src/Assets/finger/finger5.png" style="margin: 0" />
        </div>
        <div class="print_item finger2">
          <img src="/src/Assets/finger/finger6.png" style="margin: 0" />
        </div>
        <div class="print_item finger3">
          <img src="/src/Assets/finger/finger7.png" style="margin: 0" />
        </div>
        <div class="print_item finger4">
          <img src="/src/Assets/finger/finger8.png" style="margin: 0" />
        </div>
      ...
      <div class="prints_container prints_container2">
        ...
        <div class="print_item finger2">
          <img src="/src/Assets/finger/finger2.png" style="margin: 0" />
        </div>
        <div class="print_item finger3">
          <img src="/src/Assets/finger/finger3.png" style="margin: 0" />
        </div>
        <div class="print_item finger4">
          <img src="/src/Assets/finger/finger4.png" style="margin: 0" />
        </div>
        <div class="print_item finger5">
          <img src="/src/Assets/finger/finger5.png" style="margin: 0" />
        </div>
