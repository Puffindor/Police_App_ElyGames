<template>
  ...
  <div class="flex">
    ...
    <div class="other">
      <div class="total cars">
        <span class="total len">{{ this.List.length }}</span>
    ...
    <div class="search_inp">
      <input
        placeholder="Search"
        @input="(this.SearchInput = $event.target.value), Search()"
      />
  ...
  <div class="list_container">
    <div v-for="car in List" class="item">
...
export default {
  ...
  methods: {
    Search() {
      if (this.SearchInput) {
        this.SearchResault = this.cars.filter((el) =>
          el.name
            .toLocaleLowerCase()
